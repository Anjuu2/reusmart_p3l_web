    ...
    <div class="profile-card">
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            ...
            <div class="modal-header bg-light">
                <h5 class="modal-title title" id="historyModalLabel">Riwayat Pembelian</h5>
            ...
            <div class="d-flex gap-2">
                ...
                <form action="{{ route('pembeli.toggleStatus', $pembeli->id_pembeli) }}" method="POST" onsubmit="return confirm('Yakin ingin mengubah status akun?')">
                    ...
                    @if ($pembeli->status_aktif)
                        <button type="submit" class="btn btn-dark">Nonaktifkan Akun</button>
                    @else
                        <button type="submit" class="btn btn-secondary">Aktifkan Akun</button>
                    @endif
                </form>
            </div>
